    ...
    <div class="col-md-3 container d-flex flex-wrap justify-content-center mt-5">
        ...
        <main class="form-signin w-100 m-auto">
            <form action={{route('login')}} method="POST" class="flex-wrap">
                ...
                <h1 class="h3 mb-3 fw-normal d-flex justify-content-center text-center">Log In with Registered Account</h1>
                ...
                <div class="form-floating">
                    <input type="password" class="form-control" id="password" placeholder="Password" name="password" value="{{Cookie::get('userPassword') !==  null ? Cookie::get('userPassword') : ''}}">
